...
function cltvo_js(){
wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'cltvo_libs_js', 'cltvo_swiper_js', 'cltvo_slick_js'/*,'cltvo_validate_js', 'cltvo_validate_espanol_js'*/), false, true );

	wp_register_script( 'cltvo_swiper_js', JSPATH.'swiper.jquery.min.js', array('jquery'), false, true );
	wp_register_script( 'cltvo_slick_js', JSPATH.'slick.js', array('jquery'), false, true );
	wp_register_script( 'cltvo_libs_js', JSPATH.'libs.js', array(), false, true );
	...
	wp_enqueue_script('cltvo_libs_js');
